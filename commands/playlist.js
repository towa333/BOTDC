...
module.exports = {
    ...
    options: [
        {
            name: "create",
            description: "Crear una lista de reproducción.",
            ...
            options: [
                ...
                {
                    name: "public",
                    description: "públicar la lista. (true=publica playlist, false=playlist privada)",
        ...
        {
            name: "delete",
            description: "Borrar una lista de reproducción.",
            type: ApplicationCommandOptionType.Subcommand,
            options: [
                {
                    name: "name",
                    description: "Escriba el nombre de la lista de reproducción que desea eliminar.",
                    type: ApplicationCommandOptionType.String,
                    required: true
                }
            ]
        ...
        {
            name: "add-music",
            description: "Permite añadir música a la lista de reproducción.",
            type: ApplicationCommandOptionType.Subcommand,
            options: [
                {
                    name: "playlist-name",
                    description: "Escribe el nombre de una lista de reproducción.",
                    type: ApplicationCommandOptionType.String,
                    required: true
                },
                {
        ...
        {
            name: "delete-music",
            description: "Permite eliminar música de la lista de reproducción.",
            type: ApplicationCommandOptionType.Subcommand,
            options: [
                {
                    name: "playlist-name",
        ...
        {
            name: "list",
            description: "Explora la música en una lista de reproducción.",
            type: ApplicationCommandOptionType.Subcommand,
            options: [
                {
                    name: "name",
