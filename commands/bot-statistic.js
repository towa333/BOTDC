...
module.exports = {
  name: "estadística",
  description: "Visualiza las estadísticas de tu bot.",
  options: [],
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`**
• Owner: \`Towa\`
• Desarrollador: \`Towa\` & \`Waos\`
• Recuento de usuarios: \`${totalMembers || 0}\`
• Recuento de servidores: \`${totalGuilds || 0}\`
• Recuento de canales: \`${totalChannels || 0}\`
• Recuento de fragmentos: \`${shardSize || 0}\`
• Voz conectada: \`${voiceConnections}\`
• Recuento de comandos: \`${client.commands.map(c => c.name).length}\`
• Tiempo de Operación: <t:${Math.floor(Number(Date.now() - client.uptime) / 1000)}:R>
• Ping: \`${client.ws.ping} MS\`
• Uso de memoria: \`${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} MB\`
• Invitar Bot: [Click](${config.botInvite})
